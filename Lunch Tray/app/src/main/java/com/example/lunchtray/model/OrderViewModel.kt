...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        _subtotal.value = _entree.value?.let { _subtotal.value?.plus(it.price) }
    }
    ...
    fun setSide(side: String) {
        ...
        _subtotal.value = _side.value?.let { _subtotal.value?.plus(it.price) }
    }
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        _subtotal.value = _accompaniment.value?.let { _subtotal.value?.plus(it.price) }
    }
