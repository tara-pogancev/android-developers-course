...
class AmphibianViewModel : ViewModel() {
    ...
    private val _objects = MutableLiveData<List<Amphibian>>()
    val objects: LiveData<List<Amphibian>> = _objects
    ...
    fun getAmphibians() {
        ...
        try {
            viewModelScope.launch {
                ...
                _objects.value = AmphibianApi.retrofitService.getAmphibians()
            }
        } catch (e: Exception) {
