...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        return if (layout == Layout.GRID) {
            DogCardViewHolder(adapterLayout.inflate(R.layout.grid_list_item, parent, false))
        } else {
            DogCardViewHolder(adapterLayout.inflate(R.layout.vertical_horizontal_list_item, parent, false))
        }
